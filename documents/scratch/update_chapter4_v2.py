...
start_idx = content.find("CHƯƠNG 4.")
end_idx = content.find("KẾT LUẬN VÀ HƯỚNG PHÁT TRIỂN")
...
![Hình 4.1: Giao diện Dashboard quản lý doanh thu trạm](vị_trí_chèn_ảnh_4_1_dashboard)
...
![Hình 4.2: Thực nghiệm quy trình thanh toán kích hoạt máy thực tế](vị_trí_chèn_ảnh_4_2_vận_hành)
