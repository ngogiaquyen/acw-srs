...
CHƯƠNG 1. CƠ SỞ LÝ THUYẾT VÀ CÔNG NGHỆ PHẦM MỀM	15
1.1. Tổng quan về ngôn ngữ lập trình JavaScript và TypeScript	15
1.1.1. Lịch sử hình thành và vị thế của JavaScript	15
1.1.2. Kiến trúc Event Loop và cơ chế bất đồng bộ chuyên sâu	16
1.1.3. Sự ra đời của ngôn ngữ TypeScript (TS)	17
1.1.4. Các đặc tính kỹ thuật nổi bật của TypeScript	18
1.1.5. So sánh JavaScript và TypeScript trong phát triển dự án lớn	19
1.2. Thư viện ReactJS và Thuật toán Virtual DOM chuyên sâu	20
1.2.1. Giới thiệu về thư viện ReactJS	20
1.2.2. Kiến trúc dựa trên thành phần (Component-Based)	20
1.2.3. Cơ chế Virtual DOM và Thuật toán Reconciliation	22
1.2.4. Mô hình Component trong ReactJS	22
1.2.5. Quản lý luồng dữ liệu (Props và State)	23
1.2.6. React Hooks và vai trò trong phát triển ứng dụng	24
1.3. Framework Next.js và Các phương thức Rendering tiên tiến	25
1.3.1. Giới thiệu về Framework Next.js	25
1.3.2. Server-Side Rendering (SSR) và Lợi ích SEO	25
1.3.3. API Routes trong Next.js và kiến trúc Fullstack	26
1.3.4. Sự kết hợp giữa Node.js và Next.js trong kiến trúc Full-stack	27
1.4. Công nghệ IoT và Vi điều khiển ESP32	28
1.4.1. Giới thiệu về dòng chip ESP32	28
1.4.2. Giao thức truyền thông giữa Server và ESP32	29
1.5. Thiết kế và Quản trị Cơ sở dữ liệu (MySQL & Prisma ORM)	30
1.5.1. Hệ quản trị CSDL quan hệ MySQL và Tiêu chuẩn ACID	30
1.5.2. Prisma ORM và lợi ích trong phát triển hệ thống	30
1.6. Công nghệ Thanh toán và Giải pháp SePay tự động	31
1.6.1. QR Dynamic và Chuẩn VietQR (NAPAS 247)	31
1.6.2. Giải pháp SePay và Cơ chế Webhook tự động hóa	31
1.7. Thiết kế giao diện và Trải nghiệm người dùng (UI/UX)	32
1.8. Công cụ quản lý phiên bản Git và GitHub	33
1.9. Bảo mật hệ thống và Cơ chế Xác thực - Phân quyền	33
1.9.1. Xác thực với JSON Web Token (JWT)	33
1.9.2. Cơ chế phân quyền người dùng (Authorization)	34
1.10. Các thư viện và công cụ hỗ trợ phát triển	34
1.10.1. Quản lý gói với npm và pnpm	34
1.10.2. Các thư viện tiêu biểu sử dụng trong dự án	35
1.11. Ý nghĩa thực tiễn và Khoa học của đề tài	36
CHƯƠNG 2. KHẢO SÁT VÀ PHÂN TÍCH HỆ THỐNG	37
2.1. Giới thiệu hệ thống	37
2.1.1. Giới thiệu về ACW-SRS	37
2.1.2. Giới thiệu hệ thống	38
2.1.3. Mô tả bài toán	39
2.2. 2.1. Yêu cầu về hệ thống	39
2.2.1. Yêu cầu chức năng của hệ thống	39
2.2.2. Yêu cầu phi chức năng	40
2.3. Phân tích hệ thống (Sơ đồ Use Case).	41
CHƯƠNG 3. THIẾT KẾ HỆ THỐNG	42
3.1. Thiết kế chi tiết từng chức năng	42
3.1.1. Chức năng Đăng nhập	42
3.1.2. Xem thông tin người thuê	44
3.1.3. Thêm người thuê	47
3.1.4. Sửa người thuê	49
3.1.5. Chức năng Xóa người thuê	51
3.1.6. Chức năng Xem doanh thu	53
3.1.7. Chức năng Gửi báo cáo doanh thu	56
3.1.8. Chức năng Xem giao dịch	58
3.1.9. Chức năng Xuất file thống kê	61
3.1.10. Chức năng Xem thiết bị	63
3.1.11. Thêm thiết bị	65
3.1.12. Sửa cấu hình thiết bị	67
3.1.13. Xóa thiết bị	69
3.1.14. Chức năng Thanh toán	71
3.1.15. Đăng ký hệ thống	74
3.1.16. Chức năng Gửi trạng thái	76
3.1.17. Chức năng Nhận lệnh điều khiển	78
CHƯƠNG 4. TRIỂN KHAI VÀ XÂY DỰNG GIAO DIỆN HỆ THỐNG	82
4.1. Trang Đăng nhập	82
4.2. Trang Quên mật khẩu	83
4.3. Trang Quản lý Người thuê (Tenant)	84
4.4. Trang Thêm mới và Chỉnh sửa Người thuê	85
4.5. Trang Quản lý Thiết bị (IoT ESP32)	86
4.6. Trang Xem Doanh thu và Giao dịch	87
KẾT LUẬN	89



DANH MỤC HÌNH ẢNH
Hình 1.1 Sơ đồ kiến trúc hoạt động của Node.js	18
Hình 1.2 Sơ đồ cấu trúc các Component của ứng dụng Frontend	22
Hình 3 Sơ đồ cấu trúc các Component của ứng dụng Frontend	23
Hình 1.4 Cơ chế hoạt động của Virtual DOM trong React	23
Hình 1.5 So sánh mô hình Server-Side Rendering (SSR) và Client-Side Rendering (CSR)	27
Hình 1.6 Sơ đồ chi tiết các chân chức năng GPIO trên bo mạch ESP32 chuẩn	29
Hình 1.7 Sơ đồ luồng xác thực người dùng bằng JSON Web Token (JWT)	34
Hình 2.1 Sơ đồ Use Case chi tiết hệ thống	42
Hình 3.1 Biểu đồ hoạt động chức năng Đăng nhập	44
Hình 3.2 Biểu đồ trình tự chức năng Đăng nhập	45
Hình 3.3 Biểu đồ trình tự chức năng Xem thông tin người thuê	48
Hình 3.4 Biểu đồ hoạt động chức năng Thêm người thuê	49
Hình 3.5 Biểu đồ trình tự chức năng Thêm người thuê	50
Hình 3.6 Biểu đồ hoạt động chức năng Sửa người thuê	52
Hình 3.7 Biểu đồ trình tự chức năng Sửa người thuê	52
Hình 3.8 Biểu đồ hoạt động chức năng Xóa người thuê	53
Hình 3.9 Biểu đồ trình tự chức năng Xóa người thuê	54
Hình 3.10 Biểu đồ hoạt động chức năng Xem doanh thu	56
Hình 3.11 Biểu đồ trình tự chức năng Xem doanh thu	56
Hình 3.12 Biểu đồ hoạt động chức năng Gửi báo cáo doanh thu	57
Hình 3.13 Biểu đồ trình tự chức năng Gửi báo cáo doanh thu	58
Hình 3.14 Biểu đồ hoạt động chức năng Xem giao dịch	60
Hình 3.15 Biểu đồ trình tự chức năng Xem giao dịch	60
Hình 3.16 Biểu đồ hoạt động chức năng Xuất file thống kê	61
Hình 3.17 Biểu đồ trình tự chức năng Xuất file thống kê	62
Hình 3.18 Biểu đồ hoạt động chức năng Xem thiết bị	63
Hình 3.19 Biểu đồ trình tự chức năng Xem thiết bị	64
Hình 3.20 Biểu đồ hoạt động chức năng Thêm thiết bị	65
Hình 3.21 Biểu đồ trình tự chức năng Thêm thiết bị	66
Hình 3.22 Biểu đồ hoạt động chức năng Sửa cấu hình thiết bị	67
Hình 3.23 Biểu đồ trình tự chức năng Sửa cấu hình thiết bị	68
Hình 3.25 Biểu đồ trình tự chức năng Xóa thiết bị	70
Hình 3.26 Biểu đồ hoạt động chức năng Thanh toán	72
Hình 3.27 Biểu đồ trình tự chức năng Thanh toán	73
Hình 3.28 Biểu đồ hoạt động chức năng Đăng ký hệ thống	74
Hình 3.29 Biểu đồ trình tự chức năng Đăng ký hệ thống	75
Hình 3.30 Biểu đồ hoạt động chức năng Gửi trạng thái	76
Hình 3.31 Biểu đồ trình tự chức năng Gửi trạng thái	77
Hình 3.32 Biểu đồ hoạt động chức năng Nhận lệnh điều khiển	79
Hình 3.33 Biểu đồ trình tự chức năng Nhận lệnh điều khiển	80
Hình 4.1 Trang đăng nhập	89
Hình 4.2 Thông báo lỗi khi đăng nhập	90
Hình 4.3 Form yêu cầu lấy lại mật khẩu	91
Hình 4.4 Nhập mã xác thực để đổi mật khẩu	91
Hình 4.5 Trang danh sách quản lý người thuê	92
Hình 4.6 Form thêm mới người thuê	93
Hình 4.7 Trang quản lý trạng thái thiết bị	94
Hình 4.8 Trang thống kê doanh thu và giao dịch	95



DANH MỤC BẢNG
Bảng 3.1 Đặc tả chức năng đăng nhập
Bảng 3.2. Đặc tả chức năng Xem thông tin người thuê
Bảng 3.3. Đặc tả chức năng Thêm thông tin người thuê
Bảng 3.4. Đặc tả chức năng Sửa người thuê
Bảng 3.5. Đặc tả chức năng Xóa người thuê
Bảng 3.6. Đặc tả chức năng Xem doanh thu
Bảng 3.7. Đặc tả chức năng Gửi báo cáo doanh thu
Bảng 3.8. Đặc tả chức năng Xem giao dịch
Bảng 3.9. Đặc tả chức năng Xuất file thống kê
Bảng 3.10. Đặc tả chức năng Xem thiết bị
Bảng 3.11. Đặc tả chức năng Thêm thiết bị
Bảng 3.12. Đặc tả chức năng Sửa cấu hình thiết bị
Bảng 3.13. Đặc tả chức năng Xóa thiết bị
Bảng 3.14. Đặc tả chức năng Thanh toán
Bảng 3.15. Đặc tả chức năng Đăng ký hệ thống
Bảng 3.16. Đặc tả chức năng Gửi trạng thái
Bảng 3.17. Đặc tả chức năng Nhận lệnh điều khiển
Bảng 3.18. Cấu trúc bảng tenants
Bảng 3.19. Cấu trúc bảng users
Bảng 3.20. Cấu trúc bảng devices
Bảng 3.21. Cấu trúc bảng transactions
Bảng 3.22. Cấu trúc bảng device_commands
Bảng 3.23. Cấu trúc bảng device_logs
Bảng 3.24. Cấu trúc bảng leads
Bảng 3.25. Cấu trúc bảng orders
Bảng 3.26. Cấu trúc bảng password_reset_tokens
...
Ứng dụng IoT (ESP32): Cho phép kết nối các thiết bị vật lý với internet, thực hiện giám sát trạng thái trực tuyến (Heartbeat) và điều khiển bật/tắt thiết bị từ xa một cách chính xác.
Nền tảng SaaS/Multi-tenant (Next.js): Cung cấp khả năng quản lý đa người thuê, cho phép mỗi chủ trạm có một không gian làm việc riêng biệt để quản lý thiết bị và theo dõi doanh thu của chính mình.
Thanh toán tự động qua mã QR: Tích hợp các cổng thanh toán (SePay) giúp khách hàng dễ dàng tự phục vụ, hệ thống sẽ tự động kích hoạt máy ngay sau khi nhận được tiền, đảm bảo tính thuận tiện và minh bạch tuyệt đối.
...
●Tiết kiệm thời gian: Tự động hoá quy trình, giảm thiểu ghi chép. Hệ thống giúp rút ngắn thời gian thanh toán và kích hoạt máy cho khách hàng.
...
−Phương pháp nghiên cứu lý thuyết: Thực hiện nghiên cứu tài liệu về kiến trúc SaaS, giao thức HTTP cho IoT và các framework Next.js, Prisma.
...
−Ý nghĩa thực tiễn: Tạo ra một phần mềm quản lý hiệu quả cho các chủ kinh doanh rửa xe, giúp giảm thiểu rủi ro thất thoát doanh thu và nâng cao trải nghiệm khách hàng.
...
Hình 1.1 Sơ đồ kiến trúc hoạt động của Node.js
...
- Giải quyết bài toán quy mô dự án: 
  - TypeScript giúp lập trình viên phát hiện lỗi ngay trong giai đoạn biên dịch thay vì lúc vận hành.
...
1.1.4.Các đặc tính kỹ thuật nổi bật của TypeScript
...
- Hệ thống kiểu tĩnh: Cho phép định nghĩa rõ ràng kiểu dữ liệu cho biến, tham số hàm và giá trị trả về. Các kiểu dữ liệu cơ bản bao gồm: string, number, boolean, array, enum, tuple, và any. Việc xác định kiểu giúp trình biên dịch phát hiện lỗi ngay từ giai đoạn phát triển.
...
1.1.5.So sánh JavaScript và TypeScript trong phát triển dự án lớn
...
Hình 3 Sơ đồ cấu trúc các Component của ứng dụng Frontend
1.2.3.Cơ chế Virtual DOM và Thuật toán Reconciliation
- Vấn đề của Real DOM: Việc thao tác trực tiếp trên cây DOM thật là vô cùng chậm.
- Giải pháp Virtual DOM: React sẽ tạo ra một bản sao nhẹ của cây DOM trong bộ nhớ. 
...
Hình 1.4 Cơ chế hoạt động của Virtual DOM trong React
1.2.4.Mô hình Component trong ReactJS
Component là đơn vị cốt lõi trong ReactJS, cho phép chia giao diện người dùng thành nhiều phần nhỏ, độc lập và có thể tái sử dụng. Mỗi component là một file đại diện cho một phần giao diện riêng biệt như thanh điều hướng, form đăng nhập, danh sách sản phẩm hoặc nút bấm.
...
1.2.5.Quản lý luồng dữ liệu (Props và State)
- Props (Properties): Là các thuộc tính được truyền từ Component cha xuống tới Component con. Props là dữ liệu chỉ đọc (Immutable), giúp đảm bảo tính minh bạch của luồng dữ liệu trong hệ thống.
- State: Là đối tượng lưu trữ dữ liệu nội bộ của Component, có khả năng thay đổi theo thời gian dựa trên các hành động của người dùng hoặc phản hồi từ hệ thống. Khi State thay đổi, React sẽ tự động tiến hành kích hoạt quá trình cập nhật giao diện (Re-render).
...
1.2.6.React Hooks và vai trò trong phát triển ứng dụng
React Hooks được tạo ra từ phiên bản React 16.8 nhằm cho phép Functional Component sử dụng các tính năng mạnh mẽ trước đây chỉ có ở Class Component như quản lý trạng thái, xử lý vòng đời và tương tác với dữ liệu bên ngoài.
...
useState:
●Dùng để quản lý state bên trong Functional Component.
...
useContext:
●Giúp chia sẻ dữ liệu giữa nhiều component mà không phải cần truyền Props qua nhiều cấp trung gian.
...
Hình 1.5 So sánh mô hình Server-Side Rendering (SSR) và Client-Side Rendering (CSR)
...
Hình 1.6 Sơ đồ chi tiết các chân chức năng GPIO trên bo mạch ESP32 chuẩn
...
Hình 1.7 Sơ đồ luồng xác thực người dùng bằng JSON Web Token (JWT)
...
1.10.Các thư viện và công cụ hỗ trợ phát triển
...
1.10.1.Quản lý gói với npm và pnpm
...
1.10.2.Các thư viện tiêu biểu sử dụng trong dự án
...
1.11.Ý nghĩa thực tiễn và Khoa học của đề tài
...
Luồng sự kiện chính (Basic Flow)	1. Tác nhân truy cập trang đăng nhập.
...
Luồng sự kiện phụ (Alternative Flow)	3.a: Sai định dạng
...
3.1.2.Xem thông tin người thuê
Thông tin	Nội dung
...
Luồng sự kiện chính (Basic Flow)	1. Web gọi API lấy danh sách Tenant.
...
Hình 3.3 Biểu đồ trình tự chức năng Xem thông tin người thuê
3.1.3.Thêm người thuê
...
Luồng sự kiện chính (Basic Flow)	1. Admin bấm nút "Thêm mới".
...
Luồng sự kiện phụ (Alternative Flow)	4.a: Email đã tồn tại
- 4.a.1: Database báo lỗi Unique Constraint.
- 4.a.2: Server báo lỗi "Email này đã được sử dụng".
Bảng 3.3. Đặc tả chức năng Thêm thông tin người thuê
Đặc tả chức năng Thêm người thuê

Hình 3.4 Biểu đồ hoạt động chức năng Thêm người thuê

Hình 3.5 Biểu đồ trình tự chức năng Thêm người thuê
3.1.4.Sửa người thuê
Thông tin	Nội dung
...
Luồng sự kiện chính (Basic Flow)	1. Admin chọn một Tenant cần chỉnh sửa.
...
Hình 3.6 Biểu đồ hoạt động chức năng Sửa người thuê

Hình 3.7 Biểu đồ trình tự chức năng Sửa người thuê
...
Luồng sự kiện chính (Basic Flow)	1. Admin nhấn chọn "Xóa".
...
Hình 3.8 Biểu đồ hoạt động chức năng Xóa người thuê

Hình 3.9 Biểu đồ trình tự chức năng Xóa người thuê
...
Luồng sự kiện chính (Basic Flow)	1. Người dùng chọn phạm vi ngày tháng cần lấy dữ liệu.
...
Hình 3.10 Biểu đồ hoạt động chức năng Xem doanh thu

Hình 3.11 Biểu đồ trình tự chức năng Xem doanh thu
...
Luồng sự kiện chính (Basic Flow)	1. Admin bấm nút "Gửi báo cáo".
...
Luồng sự kiện phụ (Alternative Flow)	4.a: Lỗi dịch vụ gửi Email (Mail server out/Timeout)
...
Hình 3.12 Biểu đồ hoạt động chức năng Gửi báo cáo doanh thu

Hình 3.13 Biểu đồ trình tự chức năng Gửi báo cáo doanh thu
...
Luồng sự kiện chính (Basic Flow)	1. Web gửi yêu cầu lấy danh sách giao dịch (có phân trang/lọc).
...
Luồng sự kiện phụ (Alternative Flow)	2.a: Lọc theo thời điểm không cố định/ Lỗi DB
 - 2.a.1: Web thông báo không thể tìm thấy dữ liệu.

Bảng 3.8. Đặc tả chức năng Xem giao dịch


Hình 3.14 Biểu đồ hoạt động chức năng Xem giao dịch

Hình 3.15 Biểu đồ trình tự chức năng Xem giao dịch
...
Luồng sự kiện chính (Basic Flow)	1. Người dùng bấm "Xuất file".
...
Luồng sự kiện phụ (Alternative Flow)	3.a: Khối lượng dữ liệu quá lớn
 - 3.a.1: Backend xử lý quá lâu, báo Timeout.
 - 3.a.2: Web đề xuất người dùng chia nhỏ bộ lọc thời gian để xuất.
Bảng 3.9. Đặc tả chức năng Xuất file thống kê


Hình 3.16 Biểu đồ hoạt động chức năng Xuất file thống kê

Hình 3.17 Biểu đồ trình tự chức năng Xuất file thống kê
...
Luồng sự kiện chính (Basic Flow)	1. Web gửi API lấy danh sách thiết bị.
...
Luồng sự kiện phụ (Alternative Flow)	3.a: Mất đồng bộ Heartbeat Database
...
Hình 3.18 Biểu đồ hoạt động chức năng Xem thiết bị

Hình 3.19 Biểu đồ trình tự chức năng Xem thiết bị
3.1.11.Thêm thiết bị
Thông tin	Nội dung
...
Luồng sự kiện chính (Basic Flow)	1. Người dùng bấm "Thêm thiết bị mới".
...
Luồng sự kiện phụ (Alternative Flow)	4.a: MAC Address trùng lặp
 - 4.a.1: Backend báo thiết bị này đang thuộc trạm khác/ người khác.
 - 4.a.2: Hệ thống báo lỗi "MAC ID không hợp lệ".

Bảng 3.11. Đặc tả chức năng Thêm thiết bị

Hình 3.20 Biểu đồ hoạt động chức năng Thêm thiết bị

Hình 3.21 Biểu đồ trình tự chức năng Thêm thiết bị
3.1.12.Sửa cấu hình thiết bị
Thông tin	Nội dung
...
Luồng sự kiện chính (Basic Flow)	1. Bấm nút "Sửa" ở dòng thiết bị cần chỉnh.
2. Thay đổi các thuộc tính như Tên, Đơn giá/phút.
3. Bấm "Cập nhật".
4. Backend ghi lại DB, update Cache (nếu có).
5. Trả kết quả thành công.
Luồng sự kiện phụ (Alternative Flow)	2.a: Nhập số âm cho đơn giá
 - 2.a.1: Web validation bắt lỗi.
 - 2.a.2: Hiển thị lỗi "Đơn giá phải lớn hơn 0" trên form.
Bảng 3.12. Đặc tả chức năng Sửa cấu hình thiết bị


Hình 3.22 Biểu đồ hoạt động chức năng Sửa cấu hình thiết bị

Hình 3.23 Biểu đồ trình tự chức năng Sửa cấu hình thiết bị
3.1.13.Xóa thiết bị
Thông tin	Nội dung
...
Luồng sự kiện chính (Basic Flow)	1. Bấm xoá thiết bị.
...
Luồng sự kiện phụ (Alternative Flow)	4.a: Thiết bị đang trong trạng thái BUSY (đáp ứng khách)
...
Hình 3.24 Biểu đồ hoạt động chức năng Xóa thiết bị
Hình 3.25 Biểu đồ trình tự chức năng Xóa thiết bị
...
Luồng sự kiện chính (Basic Flow)	1. Khách hàng sử dụng điện thoại quét mã QR được dán trên tủ máy rửa xe.
2. Trình duyệt mở trang chọn gói dịch vụ (Dựa trên ID thiết bị lưu ở URL).
3. Khách hàng bấm chọn số lượng tiền (Vd 10.000đ).
4. Web sinh ra một mã thanh toán (Ví dụ mã QR ngân hàng nhúng mã tham chiếu).
5. Khách hàng ngân hàng quét mã và thanh toán.
...
Luồng sự kiện phụ (Alternative Flow)	5.a: Khách hàng rời đi / Đóng trang
...
Hình 3.26 Biểu đồ hoạt động chức năng Thanh toán

Hình 3.27 Biểu đồ trình tự chức năng Thanh toán 
3.1.15.Đăng ký hệ thống
Thông tin	Nội dung
...
Luồng sự kiện chính (Basic Flow)	1. Node ESP32 khởi động, truy cập Wifi.
...
Luồng sự kiện phụ (Alternative Flow)	3.a: MAC Address chua được cấu hình trong bảng Backend
 - 3.a.1: Backend trả HTTP 403 Forbidden.
 - 3.a.2: ESP32 đi vào trạng thái chờ 5p rồi đăng ký lại.
Bảng 3.15. Đặc tả chức năng Đăng ký hệ thống


Hình 3.28 Biểu đồ hoạt động chức năng Đăng ký hệ thống

Hình 3.29 Biểu đồ trình tự chức năng Đăng ký hệ thống
...
Luồng sự kiện chính (Basic Flow)	1. Mỗi N giây, ESP32 gọi HTTP GET tới /api/iot/heartbeat.
2. Gói tin gắn kèm State (Bật/Tắt).
3. Backend Cập nhật timestamp trong DB.
4. Server phản hồi 200 OK.
Luồng sự kiện phụ (Alternative Flow)	1.a: Rớt mạng Wifi trong lúc chạy
...
Hình 3.30 Biểu đồ hoạt động chức năng Gửi trạng thái

Hình 3.31 Biểu đồ trình tự chức năng Gửi trạng thái
...
Luồng sự kiện chính (Basic Flow)	1. Admin/Customer kích hoạt lệnh "Bật" cho thời gian N phút trên Server.
...
Luồng sự kiện phụ (Alternative Flow)	4.a: Mạch chập cháy, Relay không hoạt động
...
Hình 3.32 Biểu đồ hoạt động chức năng Nhận lệnh điều khiển

Hình 3.33 Biểu đồ trình tự chức năng Nhận lệnh điều khiển
...
- Hiển thị thông báo lỗi khi nhập sai thông tin tài khoản hoặc mật khẩu.
...
Hình 4.2 Thông báo lỗi khi đăng nhập
...
Hình 4.3 Form yêu cầu lấy lại mật khẩu

Hình 4.4 Nhập mã xác thực để đổi mật khẩu
...
Hình 4.5 Trang danh sách quản lý người thuê
...
Hình 4.6 Form thêm mới người thuê
...
Hình 4.7 Trang quản lý trạng thái thiết bị
...
Hình 4.8 Trang thống kê doanh thu và giao dịch
...
TÀI LIỆU THAM KHẢO
[1] Tài liệu về JavaScript và TypeScript: https://developer.mozilla.org/ , https://www.typescriptlang.org/
[2] Tài liệu về ReactJS: https://react.dev/
[3] Tài liệu về Next.js: https://nextjs.org/
[4] Tài liệu về Node.js: https://nodejs.org/
[5] Tài liệu về MySQL: https://www.mysql.com/
[6] Tài liệu về Prisma ORM: https://www.prisma.io/
[7] Tài liệu về vi điều khiển ESP32: https://www.espressif.com/
[8] Tài liệu về cổng thanh toán SePay: https://docs.sepay.vn/
[9] Tổng hợp tài liệu cho các thư viện npm: https://www.npmjs.com/
[10] Các tài liệu khác: https://openai.com/ , http://stackoverflow.com/
