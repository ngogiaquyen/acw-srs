    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-sm text-muted-foreground">
          Tổng quan hệ thống, doanh thu và hoạt động chủ trạm.
        </p>
      </div>
      ...
      <Card className="p-4">
        <div className="flex flex-wrap items-center gap-2">
          ...
          <Button asChild variant="outline" size="sm">
            <Link href="/super-admin/revenue/compare">So sánh chủ trạm</Link>
          </Button>
        </div>
      </Card>
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
        <Card className="p-4">
          <p className="text-sm text-muted-foreground">Tổng số chủ trạm</p>
      ...
      <Card className="p-6">
        <h3 className="text-base font-medium">Top chủ trạm theo doanh thu</h3>
